...
function messages($message){
	...
	try{
		...
		$key = ["admin","status","menu" , "getsemlevel", "addconsul" , 'addmix' , 'price' , 'mixprice' , 'getnivel' ,'getuser' ,"editnivel" , 'addsaldo' , 'resaldo' , 'getsaldo' , 'gift' , "gift", "pix", "users", "addadmin" , "delladm" , 'showadms' , 'send'];
